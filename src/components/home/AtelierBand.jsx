...
export function AtelierBand() {
  return (
    <section className="-mx-6 bg-olive-soft/45 md:-mx-10 lg:-mx-14">
      <div className="mx-auto grid max-w-5xl items-center gap-8 px-6 py-12 md:grid-cols-2 md:gap-16 md:px-10 md:py-16">
        ...
        <div className="mx-auto max-w-md text-center md:mx-0 md:text-left">
          <p className="font-sans text-xs tracking-[0.28em] text-olive uppercase">Atölye</p>
          <h2 className="mt-2 font-serif text-3xl md:text-4xl">Balıkesir’den, elde</h2>
